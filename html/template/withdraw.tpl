<html lang="en"><head>
		...
		<title>CSGOCROWN - Withdraw</title>
		...
		<div class="modal fade" id="confirmModal">
		    <div class="modal-dialog">
		        <div class="modal-content">
		            ...
		            <div class="modal-body">                           
		                <label>Tradelink - <a href="https://steamcommunity.com/id/me/tradeoffers/privacy#trade_offer_access_url" target="_blank">Find my trade link</a></label>
...
<div class="g-recaptcha" style="display:inline-block" data-sitekey="6LeR9QkUAAAAAIH0d4FXX-Za-Y_Z5_Wbauv6NYW2" data-callback="time"></div>
</div>
...
<div id="inlineAlert" class="alert" style="font-weight:bold"></div>
					...
					<div class="panel-body">				
			            ...
			            <div class="btn-group" id="botFilter" style="margin-bottom:10px">
			            	...
			            	<?php
			            		foreach ($bots as $key) {
			            	?>
							<label class="btn btn-default" data-bot="<?=$key?>">Bot <?=$key?>
							<?
								if($key == 9 || $key == 10 || $key == 11) { // Online Bot
							?>
							<i class="fa fa-gear" style="font-size: 12px; vertical-align: middle; color: green; margin-bottom: 2px;"></i>
							<?
								} else{ // Offline Bot
							?>
							<i class="fa fa-gear" style="font-size: 12px; vertical-align: middle; color: red; margin-bottom: 2px;"></i>
							<?
								}
							?>
							</label>
				...
				<div class="panel panel-default text-left fw-4" style="vertical-align:top">
                    ...
                    <div class="panel-body">
						<? if($withdraw_online){ ?>
                        <? if($user['deposit'] >= 20000){ ?>
                        <button class="btn btn-danger btn-lg" style="width:100%"  onclick="showConfirm()" id="showConfirmButton">Withdraw items<div style="font-size:12px">Selected: <span id="sum">0</span>/<span id="avail">0</span> coins</div></button>    
                        <? }else{ ?>
						<button class="btn btn-danger btn-lg" style="width:100%; background-color:transparent; color:#d9534f" id="showConfirmButton" disabled>You must deposit<div style="font-size:12px"><span id="sum">20$</span> To get acces to withdraw<br>You deposited <?php echo $user['xxx']; ?>/20000</div></button>
                        <? }}else{ ?>
                        <? if($user['deposit'] >= 20000){ ?>
                        <button class="btn btn-danger btn-lg" style="width:100%">Withdrawal unavailable</button>
                        <? }else{ ?>
						<button class="btn btn-danger btn-lg" style="width:100%">Withdrawal unavailable</button>
                        <? }} ?>
