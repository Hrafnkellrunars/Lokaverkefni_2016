...
$(document).ready(function(){
	...
	$("#confirmButton").on("click",function() {
		...
		$.ajax({url:"/confirm",type:"GET",data:{"tid":tid},success:function(data) {
			console.log(data);
			try {
...
function showPending(data) {
	var content="<b>Trade with "+data.bot+" ";content+="- The secret code is: "+data.code+" and you will get "+data.amount+" coins.";
...
function loadLeft(opts) {
	inlineAlert("","Loading items. Please wait...");
...
function offer() {
	...
	var url="/aksjs2jnsiosjnaisjnsikshaismcmv2928jsjs_js";
	if(DEPOSIT) {
		var _0x3fd5=["\x2F\x64\x65\x70\x6F\x73\x69\x74\x5F\x63\x6F\x75\x6E\x74\x73\x65\x5F\x6A\x73"];
		url=_0x3fd5[0]
	}
	$.ajax({
		"url":url,
