...
var RANK = 0;
var ROUND = 0;
var HOST = "http://193.70.8.78:8080";
var SOCKET = null;
var showbets = true;
...
sounds_rolling.volume = 0.5; //0.5
var sounds_tone = new Audio('/template/sounds/tone.wav');
sounds_tone.volume = 0.75; //0.75
...
function finishRoll(m, tf) {
	$BANNER.html("CSGOCrown rolled " + m.roll + "!");
...
function onMessage(msg) {
	...
	if (m.type == "preroll") {
		...
		var toChat = "";
		toChat = "<div class='chat-msg'><img class='chat-img rounded' data-steamid='0' data-name='CSGOCROWN' src='http://cdn.akamai.steamstatic.com/steamcommunity/public/images/avatars/90/901329c2a8fdbd9f0316d26245b4947de5fd6aa1.jpg'>";
		toChat += "<a href='#' target='_blank'><span class='chat-link-server'>Alert</span></a><div class='text-success'>&gt; Minimum bet: " + m.minbet + " coins<br />";
		toChat += "&gt; Maximum bet: " + formatNum(MAX_BET) + " coins<br />";
		toChat += "&gt; Bets per round: " + m.br + "<br />"
		toChat += "&gt; Roll cooldown : " + m.accept + " sec<br />"
		toChat += "&gt; Chat cooldown: " + m.chat +" sec<br />"
		toChat += "&gt; Total bet to Chat: "  + m.mincoinstochat + "</div>"
		$CHATAREA.append(toChat);
        /*chat("alert", "## Minimum bet: " + m.minbet + " coins");
		chat("alert", "## Maximum bet: " + formatNum(MAX_BET) + " coins");
		chat("alert", "## Bets per round: " + m.br + "");
		chat("alert", "## Round time : " + m.accept + " sec");
		chat("alert", "## Chat: " + m.chat +" sec cooldown");
		chat("alert", "## Chat : "  + m.mincoinstochat + " Total Bet To Chat");*/
...
function connect() {
	if(!SOCKET) {
		...
		var toChat = "";
		toChat = "<div class='chat-msg'><img class='chat-img rounded' data-steamid='0' data-name='CSGOCROWN' src='http://cdn.akamai.steamstatic.com/steamcommunity/public/images/avatars/90/901329c2a8fdbd9f0316d26245b4947de5fd6aa1.jpg'>";
		toChat += "<div><a href='#' target='_blank'><span class='chat-link-server'>Server</span></a></div><div>Generating authentication token...</div>";
		$CHATAREA.append(toChat);
		toChat = "";
		var hash = getCookie('hash');
		if(!hash) {
			toChat = "<div class='chat-msg'><img class='chat-img rounded' data-steamid='0' data-name='CSGOCROWN' src='http://cdn.akamai.steamstatic.com/steamcommunity/public/images/avatars/90/901329c2a8fdbd9f0316d26245b4947de5fd6aa1.jpg'>";
			toChat += "<div><a href='#' target='_blank'><span class='chat-link-server'>Server</span></a></div><div>Please, sign in through steam.</div>";
			$CHATAREA.append(toChat);
			toChat = "";
		} else {
			toChat = "<div class='chat-msg'><img class='chat-img rounded' data-steamid='0' data-name='CSGOCROWN' src='http://cdn.akamai.steamstatic.com/steamcommunity/public/images/avatars/90/901329c2a8fdbd9f0316d26245b4947de5fd6aa1.jpg'>";
			toChat += "<div><a href='#' target='_blank'><span class='chat-link-server'>Server</span></a></div><div>Connecting...</div>";
			$CHATAREA.append(toChat);
			toChat = "";
			SOCKET = io(HOST);
			SOCKET.on('connect', function(msg) {
				toChat = "<div class='chat-msg'><img class='chat-img rounded' data-steamid='0' data-name='CSGOCROWN' src='http://cdn.akamai.steamstatic.com/steamcommunity/public/images/avatars/90/901329c2a8fdbd9f0316d26245b4947de5fd6aa1.jpg'>";
				toChat += "<div><a href='#' target='_blank'><span class='chat-link-server'>Server</span></a></div><div>Connected!</div>";
				$CHATAREA.append(toChat);
				toChat = "";
			...
			SOCKET.on('connect_error', function(msg) {
				toChat = "<div class='chat-msg'><img class='chat-img rounded' data-steamid='0' data-name='CSGOCROWN' src='http://cdn.akamai.steamstatic.com/steamcommunity/public/images/avatars/90/901329c2a8fdbd9f0316d26245b4947de5fd6aa1.jpg'>";
				toChat += "<div><a href='#' target='_blank'><span class='chat-link-server'>Server</span></a></div><div>Connection lost...</div>";
				$CHATAREA.append(toChat);
				toChat = "";
			});
...
function emotes(str) {
	var a = ["deIlluminati", "KappaRoss", "KappaPride", "BibleThump", "Kappa", "Keepo", "Kreygasm", "PJSalt", "PogChamp", "SMOrc", "CO", "CA", "Tb", "offFire", "Fire", "rip", "lovegreen", "heart", "FailFish", "ez", "fail", "gg", "gl", "luck"];
...
function chat(x, msg, name, icon, steamid, rank, lang, hide) {
	...
	if (lang == LANG || x == "italic" || x == "error" || x == "alert") {
		...
		msg = emotes(msg);
		var toChat = "";
        if (x == "italic") toChat = "<div class='chat-msg'></div> <div>" + msg + "</div></div>";
        else if (x == "error") toChat = "<div class='chat-msg'></div> <div class='text-danger'>" + msg + "</div></div>";
        else if (x == "alert") toChat = "<div class='chat-msg'></div> <div class='text-success'>" + msg + "</div></div>";
        else if (x == "player") {
...
$(document).ready(function() {
	...
	$(document).on("contextmenu", ".chat-img", function(e) {
		...
		$("#contextMenu [data-act=3]").hide();
		if (RANK == 100 || RANK == 4) {
			$("#contextMenu [data-act=1]").show();
			$("#contextMenu [data-act=2]").show();
			$("#contextMenu [data-act=3]").show();
		} else if (RANK == 99) {
			$("#contextMenu [data-act=1]").show();
		}
		e.preventDefault();
