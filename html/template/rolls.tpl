...
<html lang="en">
	<head>
		...
		<title>CSGOCROWN - Provably Fair</title>
	...
	<?php } else { ?>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<p>All rolls on CSGOCROWN.GG are generated using a provably fair system. This means the operators cannot manipulate the outcome of any roll. Players may replicate any past roll using the below code:
				</p>
