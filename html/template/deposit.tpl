...
function redeem(){
		    ...
		    <div class="modal-dialog">
		        <div class="modal-content">
		            ...
		            <div class="modal-body">                           
						...
						By depositing/withdrawing you agree to our <a target="_blank" href="/tos">Terms of Service</a> and the Anti-Trade System.
		            </div>
		            <div class="modal-footer">
  ...
  <b><i class="fa fa-exclamation-circle"></i> After confirming the trade please click "Get coins" | Minimum deposit is $1.00 / 1000 coins.</b>
</div>
				...
				<div class="panel panel-default text-left fw-4" style="vertical-align:top">
					...
					?>
						<button class="btn btn-danger btn-lg" style="width:100%">Deposit unavailable</button>
					<?
						}
					?>
